...
windowrule = float, class:^(thunar)$,title:^(Rename.*|File Operation Progress)$
...
windowrule = opacity 1.0 override, class:$browserClass
windowrulev2 = opacity 0.9 0.9, class:^(Rofi)$
#windowrule = opacity 0.97, class:^(thunar|nemo)$
...
windowrule = size 600 340, title:^(Picture-in-Picture)$
windowrule = center, title:^(Picture-in-Picture)$
windowrule = float, title:^(imv|mpv|danmufloat|termfloat|nemo|ncmpcpp|.*Discord|(?i).*save.*|(?i).*open.*|(?i).*setting.*)$
windowrule = center, title:^(imv|mpv|danmufloat|termfloat|nemo|ncmpcpp|Discord|(?i).*save.*|(?i).*open.*|(?i).*setting.*)$
windowrule = size 960 540, title:^(imv|mpv|danmufloat|termfloat|nemo|ncmpcpp|Discord|(?i).*save.*|(?i).*open.*)$
windowrule = size 80% 80%, title:^(.*Discord)$
...
#windowrule = bordercolor $lavender, floating:1, onworkspace:w[fv1-10]
#windowrule = rounding 8, floating:1, onworkspace:w[fv1-10]
#windowrule = size 500 500, floating:1, onworkspace:w[fv1-10]
...
layerrule = animation popin 97%, rofi
